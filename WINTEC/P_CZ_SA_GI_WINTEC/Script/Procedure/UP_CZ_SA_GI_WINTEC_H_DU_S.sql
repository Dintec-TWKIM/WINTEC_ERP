...
GO
ALTER PROCEDURE [NEOE].[UP_CZ_SA_GI_WINTEC_H_DU_S]
(
...
SELECT	'N' S, A.NO_GIR, A.CD_PLANT, ML.NM_PLANT, A.CD_PARTNER, MP.LN_PARTNER, A.DT_GIR, A.DC_RMK,
	    ...
	    ISNULL(C.ST_STAT, '0') AS ST_STAT, A.DC_RMK1, MP.SN_PARTNER, MAX(GL.NO_SO) NO_SO
...
WHERE A.CD_COMPANY = @P_CD_COMPANY
    ...
    --AND		GL.QT_GIR - GL.QT_GI > 0  --의뢰수량 - 출하수량이 0보다  큰거, 2011-11-16, 최승애 주석처리함.
    AND		GL.RET = @P_RET
...
GROUP BY A.NO_GIR, A.CD_PLANT, ML.NM_PLANT, A.CD_PARTNER, MP.LN_PARTNER, A.DT_GIR, A.DC_RMK,
	    A.NO_EMP, ME.NM_KOR, C.ST_STAT, A.DC_RMK1, MP.SN_PARTNER, GW.ST_STAT, A.DC_RMK2
GO
