...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_SOSCH1_WINTEC_GI]    Script Date: 2019-11-14 오후 3:11:38 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_SOSCH1_WINTEC_GI]        
(  
...
JOIN (SELECT OL.CD_COMPANY, OL.NO_PSO_MGMT, OL.NO_PSOLINE_MGMT,
