...
/****** Object:  StoredProcedure [NEOE].[UP_SA_SOL_I]    Script Date: 2019-11-04 오전 10:37:03 ******/
SET ANSI_NULLS ON
GO
...
/*********************************************************************************************/ 
/*********************************************************************************************/ 
ALTER PROCEDURE [NEOE].[SP_CZ_SA_SOL_I_WINTEC]      
(      
	...
	@P_YN_OPTION            NCHAR(1)        = NULL, --선급검사여부
...
(      
	...
	UNIT_SO,			DT_EXPECT,			DT_DUEDATE,		    DT_REQGI,   	    QT_SO,			    UM_SO,   
	...
	NO_RELATION,        SEQ_RELATION,       CD_USERDEF1,        CD_USERDEF2,		UM_EX,
	CD_USERDEF4,		TXT_USERDEF3,		TXT_USERDEF4,		TXT_USERDEF5,		TXT_USERDEF6,
	TXT_USERDEF7,		TXT_USERDEF8,		TXT_USERDEF9,		TXT_USERDEF10,		TXT_USERDEF11,
	UM_EX_PO,			AM_EX_PO,			NO_EST,				NO_EST_HST,			SEQ_EST,
	NUM_USERDEF7,		NUM_USERDEF8,		NUM_USERDEF9,		CD_USERDEF3
)      
VALUES      
(      
	@P_CD_COMPANY,		@P_NO_SO,		    @P_SEQ_SO,		    @P_CD_PLANT,	    @P_CD_ITEM, 
	@P_UNIT_SO,			@P_DT_EXPECT,		@P_DT_DUEDATE,      @P_DT_REQGI,	    @P_QT_SO,		    @P_UM_SO,   
	...
	@P_NO_RELATION,     @P_SEQ_RELATION,    @P_CD_USERDEF1,     @P_CD_USERDEF2,		@P_UM_EX,
	@P_CD_USERDEF4,		@P_TXT_USERDEF3,	@P_TXT_USERDEF4,	@P_TXT_USERDEF5,	@P_TXT_USERDEF6,
	@P_TXT_USERDEF7,	@P_TXT_USERDEF8,	@P_TXT_USERDEF9,	@P_TXT_USERDEF10,	@P_TXT_USERDEF11,
	@P_UM_EX_PO,		@P_AM_EX_PO,		@P_NO_EST,			@P_NO_EST_HST,		@P_SEQ_EST,
	@P_NUM_USERDEF7,	@P_NUM_USERDEF8,	@P_NUM_USERDEF9,	@P_CD_USERDEF3
)      
...
-- 자동프로세스 여부
EXEC UP_SA_GIR_PROCESS_I @P_SERVERKEY, 'SA_SOL', @P_CD_COMPANY, @P_NO_SO, @P_SEQ_SO, @P_ID_INSERT

EXEC UP_SA_GI_PROCESS_I @P_SERVERKEY, 'SA_SOL', @P_CD_COMPANY, @P_NO_SO, @P_SEQ_SO, @P_ID_INSERT

EXEC UP_SA_IV_PROCESS_I @P_SERVERKEY, 'SA_SOL', @P_CD_COMPANY, @P_NO_SO, @P_SEQ_SO, @P_ID_INSERT
GO
