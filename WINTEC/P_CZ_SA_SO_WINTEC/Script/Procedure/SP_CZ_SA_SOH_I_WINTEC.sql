...
/****** Object:  StoredProcedure [NEOE].[UP_SA_SOH_I]    Script Date: 2019-11-04 오전 10:36:01 ******/
SET ANSI_NULLS ON
GO
...
/*********************************************************************************************/ 
/*********************************************************************************************/ 
ALTER PROCEDURE [NEOE].[SP_CZ_SA_SOH_I_WINTEC]      
(      
	...
	@P_TXT_USERDEF1     NVARCHAR(200)   = NULL, --거래처공정
...
(      
	...
	NO_INV,             TXT_USERDEF4,       CD_CHANCE,			NO_NEGO
)      
VALUES      
(      
	@P_CD_COMPANY,	    TRIM(UPPER(@P_NO_SO)),     @P_CD_BIZAREA,		@P_DT_SO,			@P_CD_PARTNER, 
	...
	@P_NO_INV,          @P_TXT_USERDEF4,		   @P_CD_CHANCE,		@P_NO_NEGO
)
