...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_PR_MATCHING_DEACTIVATE_SUB_JSON]    Script Date: 2017-01-05 오후 5:48:55 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_PR_MATCHING_DEACTIVATE_SUB_JSON]          
(
	@P_JSON			NVARCHAR(MAX),
