...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_PR_MATCHING_ID_OLD_SUB_S]    Script Date: 2017-01-05 오후 5:48:55 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_PR_MATCHING_ID_OLD_SUB_S]          
(
...
LEFT JOIN CZ_PR_MATCHING_DATA MD ON MD.CD_COMPANY = ID.CD_COMPANY AND MD.NO_ID_C = ID.NO_ID
