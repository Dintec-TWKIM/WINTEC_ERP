...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_PR_MATCHING_MNG_WO_I]    Script Date: 2017-01-05 오후 5:48:55 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_PR_MATCHING_MNG_WO_I]          
(
...
IF (@P_QT_WORK > (@V_QT_MATCHING - @V_QT_WORK))
BEGIN
	SET @V_ERRMSG = '실적수량은 (현합수량 - 작업수량) 보다 작거나 같아야 합니다.'
    GOTO ERROR
END
