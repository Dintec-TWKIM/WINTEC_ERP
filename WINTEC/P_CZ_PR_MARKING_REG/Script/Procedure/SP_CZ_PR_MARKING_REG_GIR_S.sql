...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_PR_MARKING_REG_GIR_S]    Script Date: 2017-01-05 오후 5:48:55 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_PR_MARKING_REG_GIR_S]          
(
...
SELECT GH.NO_GIR,
	   ...
	   MI.NO_DESIGN,
	   MI.STND_ITEM,
	   (GL.QT_GIR * BM.QT) AS QT_GIR,
	   ISNULL(GM.QT_MARKING, 0) AS QT_MARKING,
	   (MI.CD_ITEM + '_' + GH.CD_PARTNER) AS NM_FILE
FROM SA_GIRH GH
...
AND GL.QT_GIR > ISNULL(GM.QT_MARKING, 0)
ORDER BY GH.DT_GIR
