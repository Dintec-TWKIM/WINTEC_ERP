...
namespace cz
{
    public partial class P_CZ_PR_ASSEMBLING_ITEM_SUB : Duzon.Common.Forms.CommonDialog
    {
        P_CZ_PR_ASSEMBLING_ITEM_SUB_BIZ _biz = new P_CZ_PR_ASSEMBLING_ITEM_SUB_BIZ();

        public P_CZ_PR_ASSEMBLING_ITEM_SUB()
        {
            InitializeComponent();
        }
        ...
        private void InitGrid()
        {
            ...
            this._flex.SetCol("CD_ITEM", "모품목", 100, false);
            this._flex.SetCol("NM_ITEM", "모품명", 100, false);
            this._flex.SetCol("CD_PITEM", "자품목", 100, false);
            this._flex.SetCol("NM_PITEM", "자품명", 100, false);
            this._flex.SetCol("YN_MATCHING", "현합여부", 60, false, CheckTypeEnum.Y_N);
            this._flex.SetCol("CD_MITEM", "현합품목", 100, false);
            this._flex.SetCol("NM_MITEM", "현합품명", 100, false);
        ...
        private void Btn자동등록_Click(object sender, EventArgs e)
        {
            try
            {
                if (DBHelper.ExecuteNonQuery("SP_CZ_PR_ASSEMBLING_ITEM_AUTO", new object[] { Global.MainFrame.LoginInfo.CompanyCode }))
