...
namespace cz
{
    public partial class P_CZ_PR_ASSEMBLING_ID_OLD_SUB : Duzon.Common.Forms.CommonDialog
    {
        P_CZ_PR_ASSEMBLING_ID_OLD_SUB_BIZ _biz = new P_CZ_PR_ASSEMBLING_ID_OLD_SUB_BIZ();

        public P_CZ_PR_ASSEMBLING_ID_OLD_SUB()
        {
            InitializeComponent();
        ...
        private void btn삭제_Click(object sender, EventArgs e)
        {
            ...
            try
            {
				...
				{
                    Global.MainFrame.ShowMessage("조립 적용된 데이터는 삭제 할 수 없습니다.");
                    return;
                }
                else
                {
