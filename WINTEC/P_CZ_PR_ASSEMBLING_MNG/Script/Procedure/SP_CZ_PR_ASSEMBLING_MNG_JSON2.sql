...
ALTER PROCEDURE [NEOE].[SP_CZ_PR_ASSEMBLING_MNG_JSON2]          
(
	@P_JSON			NVARCHAR(MAX),
...
BEGIN TRAN SP_CZ_PR_ASSEMBLING_MNG_JSON2
BEGIN TRY
...
UPDATE WI
SET WI.TXT_OPENING = JS.TXT_OPENING,
...
COMMIT TRAN SP_CZ_PR_ASSEMBLING_MNG_JSON2

END TRY
BEGIN CATCH
	ROLLBACK TRAN SP_CZ_PR_ASSEMBLING_MNG_JSON2
