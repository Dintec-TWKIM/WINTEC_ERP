...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_PR_ASSEMBLING_MNG_JSON1]    Script Date: 2017-01-05 오후 5:48:55 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_PR_ASSEMBLING_MNG_JSON1]          
(
	@P_JSON			NVARCHAR(MAX),
...
BEGIN TRAN SP_CZ_PR_ASSEMBLING_MNG_JSON1
BEGIN TRY
...
COMMIT TRAN SP_CZ_PR_ASSEMBLING_MNG_JSON1

END TRY
BEGIN CATCH
	ROLLBACK TRAN SP_CZ_PR_ASSEMBLING_MNG_JSON1
