...
ALTER PROCEDURE [NEOE].[SP_CZ_PR_ASSEMBLING_MNG_JSON3]          
(
	@P_JSON			NVARCHAR(MAX),
...
BEGIN TRAN SP_CZ_PR_ASSEMBLING_MNG_JSON3
BEGIN TRY
...
UPDATE WI
SET WI.TXT_VENTING = JS.TXT_VENTING,
...
COMMIT TRAN SP_CZ_PR_ASSEMBLING_MNG_JSON3

END TRY
BEGIN CATCH
	ROLLBACK TRAN SP_CZ_PR_ASSEMBLING_MNG_JSON3
