...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_PR_SA_SOL_PR_WO_MAPPING_XML]    Script Date: 2020-06-30 오후 7:14:12 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_PR_SA_SOL_PR_WO_MAPPING_XML]
(
	@P_XML	XML
)
AS
...
SET XACT_ABORT ON
BEGIN TRAN SP_CZ_PR_SA_SOL_PR_WO_MAPPING
BEGIN TRY
