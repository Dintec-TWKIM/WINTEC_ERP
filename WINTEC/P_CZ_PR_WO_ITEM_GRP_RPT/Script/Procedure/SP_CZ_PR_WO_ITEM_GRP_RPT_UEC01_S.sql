...
ALTER PROCEDURE [NEOE].[SP_CZ_PR_WO_ITEM_GRP_RPT_UEC01_S]
(  
...
SELECT D.CD_COMPANY,
	   ...
	   (CASE WHEN D.QT_BOM > (ISNULL(SW.QT_APPLY, 0) + ISNULL(ST.QT_APPLY, 0)) THEN CONVERT(VARCHAR, D.QT_TOTAL) + '(' + CONVERT(VARCHAR, (ISNULL(SW.QT_APPLY, 0) + ISNULL(ST.QT_APPLY, 0))) + ')' + '/' + CONVERT(VARCHAR, D.QT_BOM)
...
SELECT 'N' AS S,
	   ...
	   A3.TXT_USERDEF8,
	   A3.NM_ST_WO,
	   MAX(UEC01) AS DC_UEC01,
	   MAX(UECP01) AS DC_UECP01,
	   MAX(UECP02) AS DC_UECP02,
	   MAX(UECP03) AS DC_UECP03,
	   MAX(UECP04) AS DC_UECP04,
	   MAX(UECP05) AS DC_UECP05,
	   MAX(UECP06) AS DC_UECP06,
	   MAX(UECP07) AS DC_UECP07,
	   MAX(UECP08) AS DC_UECP08,
	   MAX(UECP09) AS DC_UECP09,
	   MAX(UECP10) AS DC_UECP10,
	   MAX(UECP11) AS DC_UECP11,

	   MAX(UEC011) AS DC_UEC011,
	   MAX(UECP011) AS DC_UECP011,
	   MAX(UECP021) AS DC_UECP021,
	   MAX(UECP031) AS DC_UECP031,
	   MAX(UECP041) AS DC_UECP041,
	   MAX(UECP051) AS DC_UECP051,
	   MAX(UECP061) AS DC_UECP061,
	   MAX(UECP071) AS DC_UECP071,
	   MAX(UECP081) AS DC_UECP081,
	   MAX(UECP091) AS DC_UECP091,
	   MAX(UECP101) AS DC_UECP101,
	   MAX(UECP111) AS DC_UECP111,

	   MAX(UEC012) AS DC_UEC012,
	   MAX(UECP012) AS DC_UECP012,
	   MAX(UECP022) AS DC_UECP022,
	   MAX(UECP032) AS DC_UECP032,
	   MAX(UECP042) AS DC_UECP042,
	   MAX(UECP052) AS DC_UECP052,
	   MAX(UECP062) AS DC_UECP062,
	   MAX(UECP072) AS DC_UECP072,
	   MAX(UECP082) AS DC_UECP082,
	   MAX(UECP092) AS DC_UECP092,
	   MAX(UECP102) AS DC_UECP102,
	   MAX(UECP112) AS DC_UECP112
FROM (SELECT SH.NO_SO,
			 ...
			 CD.NM_SYSDEF,
			 OL.DT_IO,
			 (CASE WHEN IV.CD_WC = '완료' THEN '완료' ELSE WC.NM_WC END) AS NM_WC,
...
PIVOT (MAX(A.NO_DESIGN) FOR A.GRP_ITEM IN ([UEC01],
										   [UECP01],
										   [UECP02],
										   [UECP03],
										   [UECP04],
										   ...
										   [UECP10],
										   [UECP11])) A1
PIVOT (MAX(A1.DC_RMK) FOR A1.GRP_ITEM1 IN ([UEC011],
										   [UECP011],
										   [UECP021],
										   [UECP031],
										   [UECP041],
										   ...
										   [UECP101],
										   [UECP111])) A2
PIVOT (MAX(A2.NM_WC) FOR A2.GRP_ITEM2 IN ([UEC012],
										  [UECP012],
										  [UECP022],
										  [UECP032],
										  [UECP042],
...
GROUP BY A3.NO_SO,
		 ...
		 A3.TXT_USERDEF8,
		 A3.NM_ST_WO
HAVING (ISNULL(@P_NO_DESIGN, '') = '' OR MAX([UEC01]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([UECP01]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([UECP02]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([UECP03]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([UECP04]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([UECP05]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([UECP06]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([UECP07]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([UECP08]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([UECP09]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([UECP10]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([UECP11]) LIKE @P_NO_DESIGN + '%')
