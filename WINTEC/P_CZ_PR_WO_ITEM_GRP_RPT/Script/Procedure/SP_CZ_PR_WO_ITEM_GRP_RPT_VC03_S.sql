...
ALTER PROCEDURE [NEOE].[SP_CZ_PR_WO_ITEM_GRP_RPT_VC03_S]
(  
...
SELECT 'N' AS S,
	   ...
	   MAX([4VP01]) AS DC_4VP01,
	   MAX([4VP02]) AS DC_4VP02,
	   MAX([4VP03]) AS DC_4VP03,
	   MAX([4VP04]) AS DC_4VP04,
	   MAX([4VP05]) AS DC_4VP05,
	   MAX([4VP06]) AS DC_4VP06,
	   MAX([4VP07]) AS DC_4VP07,
	   MAX([4VP08]) AS DC_4VP08,
	   MAX([4VP40]) AS DC_4VP40, 
	   MAX([VC03]) AS DC_VC03, 

	   MAX([4VP011]) AS DC_4VP011,
	   MAX([4VP021]) AS DC_4VP021,
	   MAX([4VP031]) AS DC_4VP031,
	   MAX([4VP041]) AS DC_4VP041,
	   MAX([4VP051]) AS DC_4VP051,
	   MAX([4VP061]) AS DC_4VP061,
	   MAX([4VP071]) AS DC_4VP071,
	   MAX([4VP081]) AS DC_4VP081,
	   MAX([4VP401]) AS DC_4VP401,
	   MAX([VC031]) AS DC_VC031,

	   MAX([4VP012]) AS DC_4VP012,
	   MAX([4VP022]) AS DC_4VP022,
	   MAX([4VP032]) AS DC_4VP032,
	   MAX([4VP042]) AS DC_4VP042,
	   MAX([4VP052]) AS DC_4VP052,
	   MAX([4VP062]) AS DC_4VP062,
	   MAX([4VP072]) AS DC_4VP072,
	   MAX([4VP082]) AS DC_4VP082,
	   MAX([4VP402]) AS DC_4VP402,
	   MAX([VC032]) AS DC_VC032
...
PIVOT (MAX(A.NO_DESIGN) FOR A.GRP_ITEM IN ([4VP01],
										   [4VP02],
										   [4VP03],
										   [4VP04],
										   [4VP05],
										   ...
										   [4VP40],
										   [VC03])) A1
PIVOT (MAX(A1.DC_RMK) FOR A1.GRP_ITEM1 IN ([4VP011],
										  [4VP021],
										  [4VP031],
										  [4VP041],
										  [4VP051],
										  ...
										  [4VP401],
										  [VC031])) A2
PIVOT (MAX(A2.NM_WC) FOR A2.GRP_ITEM2 IN ([4VP012],
										  [4VP022],
										  [4VP032],
										  [4VP042],
										  [4VP052],
...
GROUP BY A3.NO_SO,
		 ...
		 A3.TXT_USERDEF8,
		 A3.NM_ST_WO
HAVING (ISNULL(@P_NO_DESIGN, '') = '' OR MAX([4VP01]) LIKE @P_NO_DESIGN + '%' OR
									     MAX([4VP02]) LIKE @P_NO_DESIGN + '%' OR
									     MAX([4VP03]) LIKE @P_NO_DESIGN + '%' OR
									     MAX([4VP04]) LIKE @P_NO_DESIGN + '%' OR
									     MAX([4VP05]) LIKE @P_NO_DESIGN + '%' OR
									     MAX([4VP06]) LIKE @P_NO_DESIGN + '%' OR
									     MAX([4VP07]) LIKE @P_NO_DESIGN + '%' OR
									     MAX([4VP08]) LIKE @P_NO_DESIGN + '%' OR
									     MAX([4VP40]) LIKE @P_NO_DESIGN + '%' OR 
										 MAX([VC03]) LIKE @P_NO_DESIGN + '%')
