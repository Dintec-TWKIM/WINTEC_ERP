...
ALTER PROCEDURE [NEOE].[SP_CZ_PR_WO_ITEM_GRP_RPT_VC05_S]
(  
...
SELECT 'N' AS S,
	   ...
	   A3.TXT_USERDEF8,
	   A3.NM_ST_WO,
	   MAX([PIV01]) AS DC_PIV01,
	   MAX([PIV02]) AS DC_PIV02,
	   MAX([PIV03]) AS DC_PIV03,
	   MAX([PIV04]) AS DC_PIV04,
	   MAX([PIV05]) AS DC_PIV05,
	   MAX([PIV06]) AS DC_PIV06,
	   MAX([PIV07]) AS DC_PIV07,
	   MAX([PIV08]) AS DC_PIV08,
	   MAX([VC05]) AS DC_VC05,

	   MAX([PIV011]) AS DC_PIV011,
	   MAX([PIV021]) AS DC_PIV021,
	   MAX([PIV031]) AS DC_PIV031,
	   MAX([PIV041]) AS DC_PIV041,
	   MAX([PIV051]) AS DC_PIV051,
	   MAX([PIV061]) AS DC_PIV061,
	   MAX([PIV071]) AS DC_PIV071,
	   MAX([PIV081]) AS DC_PIV081,
	   MAX([VC051]) AS DC_VC051,

	   MAX([PIV012]) AS DC_PIV012,
	   MAX([PIV022]) AS DC_PIV022,
	   MAX([PIV032]) AS DC_PIV032,
	   MAX([PIV042]) AS DC_PIV042,
	   MAX([PIV052]) AS DC_PIV052,
	   MAX([PIV062]) AS DC_PIV062,
	   MAX([PIV072]) AS DC_PIV072,
	   MAX([PIV082]) AS DC_PIV082,
	   MAX([VC052]) AS DC_VC052
...
PIVOT (MAX(A.NO_DESIGN) FOR A.GRP_ITEM IN ([PIV01],
										   [PIV02],
										   [PIV03],
										   [PIV04],
										   [PIV05],
										   ...
										   [PIV08],
										   [VC05])) A1
PIVOT (MAX(A1.DC_RMK) FOR A1.GRP_ITEM1 IN ([PIV011],
										  [PIV021],
										  [PIV031],
										  [PIV041],
										  [PIV051],
										  ...
										  [PIV081],
										  [VC051])) A2
PIVOT (MAX(A2.NM_WC) FOR A2.GRP_ITEM2 IN ([PIV012],
										  [PIV022],
										  [PIV032],
										  [PIV042],
										  [PIV052],
...
GROUP BY A3.NO_SO,
		 ...
		 A3.TXT_USERDEF8,
		 A3.NM_ST_WO
HAVING (ISNULL(@P_NO_DESIGN, '') = '' OR MAX([PIV01]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([PIV02]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([PIV03]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([PIV04]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([PIV05]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([PIV06]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([PIV07]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([PIV08]) LIKE @P_NO_DESIGN + '%' OR
										 MAX([VC05]) LIKE @P_NO_DESIGN + '%')
