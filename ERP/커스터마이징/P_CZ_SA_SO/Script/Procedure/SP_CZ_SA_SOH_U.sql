...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_SOH_U]    Script Date: 2015-10-01 오후 2:20:09 ******/
SET ANSI_NULLS ON
GO
...
--유    형 : 추가
--내    역 : 추가
--           기존 UP_SA_SOH_UPDATE 에서 UP_SA_SOH_U로 변경
--			 나머지 관련화면들은 UP_SA_SOH_UPDATE 로
/*********************************************************************************************/ 
ALTER PROCEDURE [NEOE].[SP_CZ_SA_SOH_U]      
(      
	...
	@P_DC_RMK_TEXT		TEXT,				--멀티비고(2011.01.05 SJH)
	...
	@P_TXT_USERDEF1     NVARCHAR(100),      --텍스트사용자정의1
	...
	@P_NUM_USERDEF1     NUMERIC(17, 4),     --숫자사용자정의1
	@P_NUM_USERDEF2     NUMERIC(17, 4),     --숫자사용자정의2
	@P_NUM_USERDEF3     NUMERIC(17, 4),     --숫자사용자정의3
