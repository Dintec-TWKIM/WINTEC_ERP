...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_SOSCH2L_S2]    Script Date: 2018-07-23 오후 1:04:58 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_SOSCH2L_S2] 
(
...
LEFT JOIN (SELECT PL.CD_COMPANY, PL.NO_SO, PL.NO_SOLINE, IL.DT_IO 
		   FROM PU_POL PL
		   ...
		   GROUP BY PL.CD_COMPANY, PL.NO_SO, PL.NO_SOLINE, IL.DT_IO) IL
...
AND (IL.DT_IO = @P_KEY OR (@P_KEY = '' AND IL.DT_IO IS NULL)) 
AND SH.NO_SO = @P_KEY2
