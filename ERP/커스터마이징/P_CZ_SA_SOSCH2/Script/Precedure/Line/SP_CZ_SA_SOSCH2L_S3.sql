...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_SOSCH2L_S3]    Script Date: 2018-07-23 오후 1:05:04 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_SOSCH2L_S3] 
(
...
AND (CASE WHEN SL.LT IN (997, 998, 999) THEN '' ELSE ISNULL(SL.DT_DUEDATE, '') END) = @P_KEY
AND SH.NO_SO = @P_KEY2
