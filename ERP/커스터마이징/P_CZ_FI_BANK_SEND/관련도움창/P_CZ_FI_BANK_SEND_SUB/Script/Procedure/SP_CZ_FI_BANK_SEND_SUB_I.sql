...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_FI_BANK_SEND_SUB_I]    Script Date: 2016-12-27 오전 11:43:43 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_FI_BANK_SEND_SUB_I]
(
...
IF(NEOE.FN_SERVERKEY('Y','VALEX|') = 'Y')
	SET @P_TRANS_GU = 'AB0' --농협 하나로브렌치
ELSE
	SET @P_TRANS_GU = '0' -- 하나은행에서 필요
