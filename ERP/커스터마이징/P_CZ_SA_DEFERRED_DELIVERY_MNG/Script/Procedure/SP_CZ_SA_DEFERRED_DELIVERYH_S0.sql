...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_DEFERRED_DELIVERY_S0]    Script Date: 2016-04-21 오후 2:16:59 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_DEFERRED_DELIVERYH_S0] 
(
...
ORDER BY SL.NO_SO, SL.DT_DUEDATE
