...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_LOG_PLAN_MNG_SHIP_S]    Script Date: 2016-02-12 오후 1:40:06 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_LOG_PLAN_MNG_SHIP_S]  
(
    @P_NO_REV       INT,
    @P_NO_IDX       INT
)
...
WHERE PS.CD_COMPANY IN ('K100', 'K200') 
AND PS.NO_REV = @P_NO_REV
AND PS.NO_IDX = @P_NO_IDX
