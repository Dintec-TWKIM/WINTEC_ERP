...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_LOG_PLAN_MNG_GIR_SHIP_S]    Script Date: 2016-02-12 오후 1:40:06 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_LOG_PLAN_MNG_GIR_SHIP_S]  
(
...
(
    ...
    AND (WD.CD_MAIN_CATEGORY = '001' OR 
         (WD.CD_MAIN_CATEGORY = '003' AND WD.CD_SUB_CATEGORY = '007'))
