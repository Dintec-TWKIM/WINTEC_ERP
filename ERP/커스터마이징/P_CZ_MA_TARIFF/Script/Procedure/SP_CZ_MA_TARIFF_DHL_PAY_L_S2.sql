...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_MA_TARIFF_DHL_PAY_L_S2]    Script Date: 2016-06-27 오후 5:01:58 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_MA_TARIFF_DHL_PAY_L_S2]          
(  
...
JOIN CZ_MA_TARIFF_DHL_STD_L SL ON SL.CD_COMPANY = PH.CD_COMPANY AND SL.DT_YEAR = SUBSTRING(PH.DT_MONTH, 1, 4) AND SL.TP_TARIFF = '002'
