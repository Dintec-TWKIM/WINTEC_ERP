...
namespace cz
{
	class P_CZ_PU_REQ_REG_1_BIZ
	{
		internal DataTable SearchLOT()
		{
		...
		internal DataTable SearchSerial()
		{
			SpInfo si = new SpInfo();
		...
		internal DataSet Search(string NO_RCV, string YN_AUTORCV)
		{
		...
		internal DataTable SearchMATL(string NO_PO)
		{
		...
		internal DataTable SearchMATL(string NO_PO_MULTI, object[] obj)
		{
			DataTable dt결과 = null;
			try
			{
		...
		internal bool Save(DataTable dtH, DataTable dtL, DataTable dtLOT, string no_ioseq, DataTable dtSERL, string CD_PLANT, string NO_REQ, DataTable dtLOCATION, string YN_SPECIAL, DataTable dtHH, DataTable dtLL)
		{
			...
			if (dtH != null)
			{
				...
				siH.SpParamsInsert = new string[] { "NO_RCV",
													"CD_COMPANY",
													"CD_PLANT",
													"CD_PARTNER",
													"DT_REQ",
													...
													"CD_DEPT",
													"DC_RMK_TEXT" };
				siH.SpParamsUpdate = new string[] { "CD_COMPANY",
													"NO_RCV",
													"DC_RMK",
													"ID_INSERT",
													"DC_RMK_TEXT",
			...
			if (dtL != null)
			{
				...
				siL.SpParamsInsert = new string[] { "NO_RCV",
													"NO_LINE",
													"CD_COMPANY",
													"NO_PO",
													"NO_POLINE",
													...
													"UM_WEIGHT",
													"TOT_WEIGHT" };
				siL.SpParamsUpdate = new string[] { "NO_RCV",
													"NO_LINE",
													"CD_COMPANY",
													"DT_LIMIT",
													"QT_REQ",
													...
													"UM_WEIGHT",
													"TOT_WEIGHT" };
				siL.SpParamsDelete = new string[] { "NO_RCV",
													"NO_LINE",
													"CD_COMPANY" };
			...
			if (dtH != null && dtL != null)
			{
				...
				si.SpParamsInsert = new string[] { "NO_IO1",
												   "CD_COMPANY",
												   "CD_PLANT",
												   "CD_PARTNER",
												   "FG_TRANS",
				...
				si.SpParamsInsert = new string[] { "YN_RETURN1",
												   "NO_IO",
												   "NO_IOLINE",
												   "CD_COMPANY",
												   "CD_PLANT",
			...
			if (YN_SPECIAL == "Y" && dtL != null) //특채수량 사용시..
			{
				...
				siSpecial.SpParamsInsert = new string[] { "CD_COMPANY",
														  "NO_REV",
														  "NO_REVLINE",
														  "JAN_QT_PASS",
														  "JAN_QT_SPECIAL" };
			...
			if (dtLOT != null)
			{
				...
				si03.SpParamsInsert = new string[] { "CD_COMPANY",
													 "NO_IO",
													 "NO_IOLINE",
													 "NO_LOT",
													 "CD_ITEM",
													 ...
													 "CD_MNG19",
													 "CD_MNG20" };
				si03.SpParamsUpdate = new string[] { "CD_COMPANY",
													 "NO_IO",
													 "NO_IOLINE",
													 "NO_LOT",
													 "QT_IO",
													 "QT_IO_OLD" };
				si03.SpParamsDelete = new string[] { "CD_COMPANY",
													 "NO_IO",
													 "NO_IOLINE",
													 "NO_IOLINE2",
													 "NO_LOT" };
			...
			if (dtSERL != null)
			{
				...
				si04.CompanyID = Global.MainFrame.LoginInfo.CompanyCode;
				si04.SpParamsInsert = new string[] { "CD_COMPANY",
													 "NO_SERIAL",
													 "NO_IO",
													 "NO_IOLINE",
													 "CD_ITEM",
													 ...
													 "CD_PLANT",
													 "ID_INSERT" };
				si04.SpParamsUpdate = new string[] { "CD_COMPANY",
													 "NO_SERIAL",
													 "NO_IO",
													 "NO_IOLINE",
													 "CD_ITEM",
				...
				si04.SpParamsDelete = new string[] { "CD_COMPANY",
													 "NO_IO",
													 "NO_IOLINE",
													 "NO_SERIAL" };
			...
			if (dtLOCATION != null && dtLOCATION.Rows.Count > 0)
			{
				...
				si05.SpParamsInsert = new string[] { "CD_COMPANY",
													 "NO_IO",
													 "NO_IOLINE",
													 "CD_LOCATION",
													 "CD_ITEM",
			...
			if (dtHH != null)
			{
				...
				si06.SpParamsInsert = new String[] { "NO_IO",
													 "CD_COMPANY",
													 "CD_PLANT",
													 "CD_PARTNER",
													 "FG_TRANS",
			...
			if (dtLL != null)
			{
				...
				si07.SpParamsInsert = new string[] { "YN_RETURN",
													 "NO_IO",
													 "NO_IOLINE",
													 "CD_COMPANY",
													 "CD_PLANT",
													 ...
													 "CD_ITEM",
													 "SEQ_PROJECT" };
				si07.SpParamsDelete = new string[] { "CD_COMPANY",
													 "NO_IO",
													 "NO_IOLINE" };
		...
		internal void Delete(object[] p_param1, object[] p_param2)
		{
			Global.MainFrame.ExecSp("UP_PU_RCVH_DELETE_1", p_param1);
		}

		internal string EnvSearch()
		{
		...
		internal DataTable GetMailAdress(DataTable no_po)
		{
			...
			foreach (DataRow dr in no_po.Rows)
			{
				string SelectQuery = @"SELECT PA.EMP_WRITE,
											  ...
											  ME.NM_KOR,
											  ME.NO_EMAIL
                                       FROM PU_POL PP WITH(NOLOCK)
                                       JOIN PU_APPH PA WITH(NOLOCK) ON PP.NO_APP = PA.NO_APP AND PP.CD_COMPANY = PA.CD_COMPANY 
						               JOIN MA_EMP ME WITH(NOLOCK) ON PA.EMP_WRITE = ME.NO_EMP AND PA.CD_COMPANY = ME.CD_COMPANY
								       WHERE PA.CD_COMPANY ='" + Global.MainFrame.LoginInfo.CompanyCode + "'" + Environment.NewLine + 
		...
		internal string GetNO_IO(string NO_IO)
		{
			...
			string SelectQuery = @"SELECT MAX(NO_IO) AS NO_IO
								  ...
								  "AND NO_IO_MGMT = '" + NO_IO + "'" + Environment.NewLine +
								  "AND CD_BIN_REF = '99'";
		...
		internal string GetNO_IO_MGMT(string NO_ISURCV)
		{
			string NO_IO_GI = string.Empty;
		...
		internal string getCD_SL(string CD_PARTNER, string CD_PLANT)
		{
			string NO_IO_GI = string.Empty;
			string SelectQuery = @"SELECT MAX(CD_SL) AS CD_SL
								   FROM SU_PARTSL WITH(NOLOCK)
								   WHERE CD_COMPANY = '" + Global.MainFrame.LoginInfo.CompanyCode + "'" + Environment.NewLine +
								  "AND CD_PARTNER = '" + CD_PARTNER + "'" + Environment.NewLine +
		...
		internal DataSet InitialDataSet()
		{
			...
			ds.Tables[0].Columns.Add("NO_BL", typeof(string));
		...
		internal DataTable SearchBarcodeRev(object[] obj)
		{
