...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_INQ_RPTH_003_001_S]    Script Date: 2019-01-08 오후 4:35:18 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_INQ_RPTH_003_001_S]  
(
...
FROM (SELECT WH.CD_COMPANY, WH.NO_KEY,
	  ...
	  AND (ISNULL(@P_NO_KEY, '') = '' OR EXISTS (SELECT 1
												 FROM SA_IVL IL
												 WHERE IL.CD_COMPANY = WH.CD_COMPANY 
												 AND IL.NO_SO = WH.NO_KEY
												 AND IL.NO_IV LIKE @P_NO_KEY + '%'))
