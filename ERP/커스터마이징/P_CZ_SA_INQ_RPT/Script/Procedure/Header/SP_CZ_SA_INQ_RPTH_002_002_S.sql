...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_INQ_RPTH_002_002_S]    Script Date: 2019-01-08 오후 4:34:59 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_INQ_RPTH_002_002_S]  
(
...
FROM (SELECT WH.CD_COMPANY, WH.NO_KEY,
	  ...
	  AND (ISNULL(@P_NO_KEY, '') = '' OR EXISTS (SELECT 1 
												 ...
												 AND SH.NO_SO = WH.NO_KEY
												 AND SH.NO_PO_PARTNER LIKE '%' + @P_NO_KEY + '%'))
