...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_INQ_RPTH_000_002_S]    Script Date: 2019-01-08 오후 4:33:58 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_INQ_RPTH_000_002_S]  
(
...
FROM (SELECT WH.CD_COMPANY, WH.NO_KEY,
	  ...
	  AND (ISNULL(@P_NO_KEY, '') = '' OR WH.NO_KEY LIKE '%' + @P_NO_KEY + '%')
