...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_BILLSD_U]    Script Date: 2016-04-28 오후 2:33:11 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_BILLSD_U]
(
...
--BEGIN
--	UPDATE         SA_IVH
--	SET AM_BAN = AM_BAN - @AM_ORIGINAL + @AM_BAN
--	WHERE CD_COMPANY = @CD_COMPANY
--	        AND NO_IV = @NO_IV
--END
--ELSE IF (@GUBUN = '1')
...
SET CD_COMPANY = @P_CD_COMPANY, 
	...
	AM_PL = @P_AM_PL,
	NO_DOCU_RCP = @P_NO_DOCU_RCP,
	NO_DOLINE_RCP = @P_NO_DOLINE_RCP,
