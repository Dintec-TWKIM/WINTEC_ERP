...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_BI_INQ_INPUT_TIME_CHART_S3]    Script Date: 2018-08-30 오후 1:02:57 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_BI_INQ_INPUT_TIME_CHART_S3]
(
...
(
	...
	LEFT JOIN MA_USER MU ON MU.CD_COMPANY = WH.CD_COMPANY AND MU.ID_USER = WH.ID_TYPIST
	GROUP BY QH.NM_SALEORG, MU.NM_USER 
)
SELECT NM_SALEORG,
	   NM_USER,
	   QT_FILE,
