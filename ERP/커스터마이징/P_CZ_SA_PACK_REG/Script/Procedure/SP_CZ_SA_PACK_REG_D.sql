...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_PACK_REG_D]    Script Date: 2015-09-14 오후 3:30:26 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_PACK_REG_D]
(
...
EXEC SP_CZ_SA_PACK_LOG @P_CD_COMPANY, @P_NO_GIR, @P_ID_DELETE, 'SP_CZ_SA_PACK_REG_D'
