...
string vessel;
        ...
        public KSS_pdf(string fileName)
        {
            vessel = "";                        // 선명
            reference = "";                     // 문의번호
        ...
        public void Parse()
        {
            ...
            foreach (DataTable dt in ds.Tables)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (firstStr.StartsWith("Requisition No"))
                    {
                    ...
                    if (string.IsNullOrEmpty(reference))
                    {
                        ...
                        {
                            if (dt.Rows[i][c].ToString().Contains("Req' No"))
                            {
                    ...
                    else if (GetTo.IsInt(firstStr))
                    {
                        ...
                        if (_itemDesc != -1)
                        {
                            ...
                            iTemCode = dt.Rows[i][_itemDesc].ToString().Trim();

                            if (string.IsNullOrEmpty(iTemDESC))
                                iTemDESC = dt.Rows[i - 1][_itemDesc + 1].ToString().Trim();
                        }
