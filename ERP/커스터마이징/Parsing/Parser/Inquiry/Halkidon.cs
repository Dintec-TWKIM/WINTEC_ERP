...
namespace Parsing
{
    class Halkidon
    {
        ...
        public Halkidon(string fileName)
        {
            reference = "";
            vessel = "";
        ...
        public void Parse()
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                string secondColStr = dt.Rows[i][8].ToString();

                if (secondColStr.StartsWith("RFQ"))
                {
                    reference = dt.Rows[i][9].ToString().Trim();
                }
                else if (secondColStr.StartsWith("Vessel"))
                {
                    vessel = dt.Rows[i][9].ToString().Trim();
                }
                ...
                else if (firstColStr.Contains("REQ-"))
                {
                    if (!_itemQt.Equals(-1))
