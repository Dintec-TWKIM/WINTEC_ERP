            ...
            foreach (DataTable dt in ds.Tables)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (string.IsNullOrEmpty(reference))
                    {
                        ...
                        {
                            if (dt.Rows[i][c].ToString().ToUpper().StartsWith("REQUEST QUOTE ID"))
                    ...
                    else if (GetTo.IsInt(secondColStr) || GetTo.IsInt(firstColStr))
                    {
                        ...
                        if (!_itemDesc.Equals(-1))
                        {
                            ...
                            int _i = i + 1;
                            while (string.IsNullOrEmpty(dt.Rows[_i][1].ToString()) && !dt.Rows[_i][_itemCode].ToString().Contains("Freight Terms") && !dt.Rows[_i][_itemCode].ToString().Contains("ECCN NO:"))
                            {
