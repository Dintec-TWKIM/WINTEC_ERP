                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    else if (firstColStr.Equals("No"))
                    {
                        for (int c = 1; c < dt.Columns.Count; c++)
                        {
                            ...
                            else if (dt.Rows[i][c].ToString().StartsWith("Maker")) _itemMaker = c;
                            else if (dt.Rows[i][c].ToString().StartsWith("Qty Req")) _itemQt = c;
                            else if (dt.Rows[i][c].ToString().StartsWith("Unit")) _itemUnit = c;
                            else if (dt.Rows[i][c].ToString().StartsWith("Remarks")) _itemRmk = c;
                        }
                    }
                    else if (GetTo.IsInt(firstColStr))
                    {
                        ...
                        else if (!string.IsNullOrEmpty(iTemMaker))
