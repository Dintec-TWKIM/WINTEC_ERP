        ...
        public void Parse()
        {
            ...
            foreach (DataTable dt in ds.Tables)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (firstColStr.Equals("INQUIRY NO."))
                    {
                    ...
                    else if (firstColStr.Equals("FOR"))
                    {
                    ...
                    else if (firstColStr.Equals("Pos."))
                    {
                        for (int c = 1; c < dt.Columns.Count; c++)
                        {
                            ...
                            else if (dt.Rows[i][c].ToString().Equals("Quantity / Unit")) _itemQt = c;
                        }
                    }
                    else if (GetTo.IsInt(firstColStr))
                    {
                        ...
                        if (!_itemDesc.Equals(-1))
                        {
                            ...
                            while (string.IsNullOrEmpty(dt.Rows[_i][0].ToString()))
                            {
                                ...
                                if (dt.Rows[_i][_itemDesc].ToString().Contains("--- Please see") || _i >= dt.Rows.Count)
                                    break;
                            }
                        }
