...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_GIR_D]    Script Date: 2015-04-27 오후 8:14:05 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_GIR_D]  
(  
...
BEGIN
	...
	DELETE FROM CZ_SA_GIRH_WORK_DETAIL
	WHERE CD_COMPANY = @P_CD_COMPANY
	AND NO_GIR = @P_NO_GIR
	...
	DELETE FROM CZ_SA_GIRH_REMARK
	WHERE CD_COMPANY = @P_CD_COMPANY
	AND NO_GIR = @P_NO_GIR
END

COMMIT TRAN SP_CZ_SA_GIR_D

END TRY
BEGIN CATCH
	ROLLBACK TRAN SP_CZ_SA_GIR_D
