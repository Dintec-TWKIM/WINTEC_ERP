...
namespace cz
{
	class P_CZ_SA_GIR_BIZ
	{
        private string 회사코드;

        public P_CZ_SA_GIR_BIZ(string 회사코드)
        {
            this.회사코드 = 회사코드;
        }
		...
		public DataSet 기본정보검색(object[] obj)
		{
            ...
            ds = DBHelper.GetDataSet("SP_CZ_SA_GIR_S", obj);
            ...
            ds.Tables[0].Columns["CD_FORWARDER"].DefaultValue = "001";
            ds.Tables[0].Columns["NO_IMO"].DefaultValue = string.Empty;
            ds.Tables[0].Columns["NO_IMO_BILL"].DefaultValue = string.Empty;
            ...
            ds.Tables[0].Columns["YN_PACKING"].DefaultValue = "N";
            ds.Tables[0].Columns["YN_TAX_RETURN"].DefaultValue = "N";
            ds.Tables[0].Columns["DC_RMK"].DefaultValue = string.Empty;
            ds.Tables[0].Columns["DT_COMPLETE"].DefaultValue = string.Empty;

            ds.Tables[0].Columns["FG_REASON"].DefaultValue = "1";
            ds.Tables[0].Columns["DT_AUTO_COMPLETE"].DefaultValue = "2";

            if (ds.Tables[0].Rows.Count > 0 && string.IsNullOrEmpty(D.GetString(ds.Tables[0].Rows[0]["DT_AUTO_COMPLETE"])))
                ds.Tables[0].Rows[0]["DT_AUTO_COMPLETE"] = "2";

            ds.Tables[0].Columns["YN_LOADING"].DefaultValue = "N";
            ds.Tables[0].Columns["YN_DOMESTIC"].DefaultValue = "N";
		...
		public bool 기본정보저장(DataTable dt)
		{
            ...
            si.SpNameInsert = "SP_CZ_SA_GIRH_I";
            si.SpNameUpdate = "SP_CZ_SA_GIRH_U";
		...
		public bool 기본정보제거(string 의뢰번호)
		{
            ...
            result = (ResultData)Global.MainFrame.ExecSp("SP_CZ_SA_GIR_D", new object[] { this.회사코드, 의뢰번호, Global.MainFrame.LoginInfo.UserID });
		...
		public bool 의뢰번호중복체크(string 의뢰번호)
		{
			...
			query = "SELECT COUNT(1)" + Environment.NewLine +
                    "FROM SA_GIRH WITH(NOLOCK)" + Environment.NewLine +
		...
		public bool 품목정보저장(DataTable dt, string 의뢰번호, string 송장번호)
		{
			...
			if (dt != null)
			{
                ...
                si.SpNameInsert = "SP_CZ_SA_GIRL_XML";
		...
		public bool Check(object[] obj, out decimal 분할의뢰수량)
		{
            ...
            dt = DBHelper.GetDataTable("UP_SA_GIR_S", obj, out outs);
