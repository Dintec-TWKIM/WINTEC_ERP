...
namespace cz
{
    class P_CZ_SA_GI_BIZ
    {
        string 출고등록_검사 = "000";

        public P_CZ_SA_GI_BIZ()
        {
            출고등록_검사 = BASIC.GetMAEXC("출고등록_검사");
        }
        ...
        public DataTable Search(object[] obj, string str조회일자구분)
        {
            ...
            {
                case "GI":
                    strProc = "SP_CZ_SA_GIH_GI_S";
                    break;
                case "DU":
                    strProc = "SP_CZ_SA_GIH_DU_S";
                    break;
                case "RQ":
                    strProc = "SP_CZ_SA_GIH_RQ_S";
                    break;
            }
        ...
        #region ♣ 저장
        public bool Save(DataTable dt_H, DataTable dt_L, DataTable dtLocation, DataTable dt_LOT, DataTable dt_SERIAL, string 출고일자, DataTable dt_ASN)
        {
            ...
            if (dt_H != null)
            {
                ...
                siM.SpNameInsert = "SP_CZ_SA_GIH_I";
                siM.SpParamsInsert = new String[] { "CD_COMPANY",   "NO_IO",    "NO_GIR",   "CD_PLANT",     "CD_PARTNER",   
                                                    "FG_TRANS",     "DT_IO",    "CD_DEPT",  "NO_EMP",       "DC_RMK",
                                                    "YN_RETURN",    "ID_INSERT" };
                sic.Add(siM);
            }
            ...
            if (dtLocation != null && dtLocation.Rows.Count > 0)
            {
                ...
                if (!dtLocation.Columns.Contains("DT_IO"))
                    siLocation.SpParamsValues.Add(ActionState.Insert, "DT_IO", 출고일자);
        ...
        internal string Get출고등록_검사 { get { return 출고등록_검사; } }
