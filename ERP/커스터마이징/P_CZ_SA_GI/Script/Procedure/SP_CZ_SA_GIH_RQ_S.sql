...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_GI_H_RQ_S]    Script Date: 2015-10-20 오후 4:21:30 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_GIH_RQ_S]
(
...
WHERE A.CD_COMPANY = @P_CD_COMPANY
    ...
    AND		GL.DT_REQGI BETWEEN @P_DT_GIR_FROM AND @P_DT_GIR_TO
