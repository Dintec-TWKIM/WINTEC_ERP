...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_GI_H_GI_S]    Script Date: 2015-10-20 오후 4:21:23 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_GIH_GI_S]
(
...
SELECT DISTINCT 'N' S, A.NO_GIR, A.CD_PLANT, ML.NM_PLANT, A.CD_PARTNER, MP.LN_PARTNER, A.DT_GIR, 
    A.DC_RMK, '' NO_IO, '' FG_TRANS, '' DT_IO, '' CD_DEPT, '' NO_EMP, '' YN_RETURN, 
    A.NO_EMP NO_GI_EMP, ME.NM_KOR, ISNULL(C.ST_STAT, '0') ST_STAT,
    A.DC_RMK1, MP.SN_PARTNER
FROM SA_GIRL GL
