...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_HR_PEVALU_HUMEMP_S2]    Script Date: 2015-10-27 오후 7:08:52 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_HR_PEVALU_HUMEMP_S2]  
(
...
SELECT 'N' AS S,
	   ...
	   HP.CD_CC,
	   HP.CD_GROUP
FROM HR_PEVALU_HUMEMPAN HP
LEFT JOIN MA_EMP EP ON EP.CD_COMPANY = HP.CD_BIZAREA AND EP.NO_EMP = HP.NO_EMPAN
