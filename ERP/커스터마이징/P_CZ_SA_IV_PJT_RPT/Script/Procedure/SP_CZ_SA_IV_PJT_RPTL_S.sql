...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_IV_PJT_RPTL_S]    Script Date: 2016-06-23 오후 4:50:57 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_IV_PJT_RPTL_S]  
(
...
AND (AC.CD_ACGRP = '112' OR AC.CD_ACGRP = '520' OR AC.CD_ACGRP = '540' OR AC.CD_ACGRP = '570')
