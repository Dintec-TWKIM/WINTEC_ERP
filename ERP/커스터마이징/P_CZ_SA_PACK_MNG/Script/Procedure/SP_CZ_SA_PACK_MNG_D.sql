...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_PACK_MNG_D]    Script Date: 2015-09-14 오후 4:08:35 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_PACK_MNG_D]
(
...
EXEC SP_CZ_SA_PACK_LOG @P_CD_COMPANY, @P_NO_GIR, @P_ID_DELETE, 'SP_CZ_SA_PACK_MNG_D'
