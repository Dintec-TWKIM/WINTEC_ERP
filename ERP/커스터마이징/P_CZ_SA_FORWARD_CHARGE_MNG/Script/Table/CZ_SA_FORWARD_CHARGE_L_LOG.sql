...
/****** Object:  Table [NEOE].[CZ_SA_FORWARD_CHARGE_L_LOG]    Script Date: 2022-05-13 오후 2:22:15 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [NEOE].[CZ_SA_FORWARD_CHARGE_L_LOG](
 ...
 CONSTRAINT [PK_CZ_SA_FORWARD_CHARGE_L_LOG] PRIMARY KEY CLUSTERED 
(
	[IDX] ASC
