...
/****** Object:  Table [NEOE].[SA_RCPD]    Script Date: 2016-04-28 오후 1:34:05 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [NEOE].[SA_RCPD] ADD  DEFAULT (0) FOR [AM_IV]
GO

ALTER TABLE [NEOE].[SA_RCPD] ADD  DEFAULT (0) FOR [AM_RCP_TX]
GO
