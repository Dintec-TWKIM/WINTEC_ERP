...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_IVL_AUTO_RPT_S]    Script Date: 2015-06-22 오후 7:27:55 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_IVL_AUTO_RPT_S]
(
	@P_CD_COMPANY		    NVARCHAR(7),
    @P_NO_IV				NVARCHAR(20),
	@P_YN_PARTIAL			NVARCHAR(1)
)
...
(
	...
	WHERE A.QT_CLS = A.QT_SO
	AND A.QT_CLS = SL.QT_SO	
)
...
AND (ISNULL(@P_YN_PARTIAL, '') = 'N' OR EXISTS (SELECT 1 
												FROM B 
												WHERE B.CD_COMPANY = IL.CD_COMPANY 
												AND B.NO_SO = IL.NO_SO))
