...
namespace Dintec
{
	public static class E2H
	{
		...
		public static string EngToKor(string eng, bool detectCase = false)
		{
		...
		public static string ToEnglish(this string hangul)
		{
			...
			var sb = new StringBuilder(hangul.Length * 2);
			...
			do
			{
				...
				if (!Split(hangul[i], out ini, out vow, out und))
