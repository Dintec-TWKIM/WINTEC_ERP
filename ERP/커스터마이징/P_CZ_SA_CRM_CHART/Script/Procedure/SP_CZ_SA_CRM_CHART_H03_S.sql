...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_SA_CRM_CHART_H03_S]    Script Date: 2017-07-13 오후 3:13:12 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [NEOE].[SP_CZ_SA_CRM_CHART_H03_S]
(
...
FROM (SELECT QH.CD_COMPANY, QH.NO_IMO,
	  		 SUM(1.0) AS QT_QTN,
	  ...
	  GROUP BY QH.CD_COMPANY, QH.NO_IMO) QH
JOIN CZ_MA_HULL MH ON MH.NO_IMO = QH.NO_IMO
