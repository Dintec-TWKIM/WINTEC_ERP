...
/****** Object:  StoredProcedure [NEOE].[SP_CZ_MA_WORKFLOWH_S_13]    Script Date: 2018-08-13 오전 9:47:46 ******/
SET ANSI_NULLS ON
GO
...
-- 납품목록
ALTER PROCEDURE [NEOE].[SP_CZ_MA_WORKFLOWH_S_13]  
(
...
SELECT 'N' AS S,
	   ...
	   MU1.NM_USER AS NM_LOG,
	   SH.DC_RMK_TEXT2 AS DC_RMK
...
LEFT JOIN MA_USER MU1 ON MU1.CD_COMPANY = WH.CD_COMPANY AND MU1.ID_USER = WH.ID_LOG
