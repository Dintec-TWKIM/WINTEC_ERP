...
namespace cz
{
    public partial class P_CZ_SA_RCP_SUB : Duzon.Common.Forms.CommonDialog, IHelpWindow
    {
        ...
        public P_CZ_SA_RCP_SUB()
        {
            this.InitializeComponent();
        }

        public P_CZ_SA_RCP_SUB(string 수금일자)
        {
        ...
        public P_CZ_SA_RCP_SUB(DataTable 매출반제, string 수금일자)
        {
            this.dt매출반제 = 매출반제;
            this.수금일자 = 수금일자;
            this.InitializeComponent();
        ...
        private void InitGrid()
        {
            ...
            this._flex.SetCol("NM_DEPT", "마감부서", 100);
            this._flex.SetCol("NM_EMP", "마감담당자", 100);
            this._flex.SetCol("DC_REMARK", "비고", 100);
            this._flex.SetCol("AM_EX_ALL", "총매출외화금액", 100, true, typeof(decimal), FormatTpType.FOREIGN_MONEY);
            ...
            this._flex.LoadUserCache("P_CZ_SA_RCP_SUB_flex");
        }
        ...
        private void btn조회_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this._flex.Binding = DBHelper.GetDataTable("SP_CZ_SA_RCP_SUB_S", new object[] { Global.MainFrame.LoginInfo.CompanyCode,
        ...
        {
            this._flex.SaveUserCache("P_CZ_SA_RCP_SUB_flex");
        }
