...
namespace cz
{
    public class P_CZ_SA_RCP_BIZ
    {
        private IMainFrame _mf;

        public P_CZ_SA_RCP_BIZ(IMainFrame mf)
        {
            this._mf = mf;
        }
        ...
        {
            ResultData resultData = (ResultData)this._mf.FillDataSet("SP_CZ_SA_RCP_S", new object[] { this._mf.LoginInfo.CompanyCode,
        ...
        public bool Save(string DtRcp, string BillPartner, DataTable dtH, DataTable dtL, DataTable dtB)
        {
            ...
            if (dtB != null)
                spCollection.Add(new SpInfo()
                {
                    ...
                    CompanyID = this._mf.LoginInfo.CompanyCode,
                    UserID = this._mf.LoginInfo.EmployeeNo,
                    SpNameInsert = "SP_CZ_SA_RCPD_I",
                    SpNameUpdate = "SP_CZ_SA_RCPD_U",
        ...
        {
            this._mf.ExecSp("SP_CZ_SA_RCP_AUTO_SLIP", new object[] { this._mf.LoginInfo.CompanyCode,
                                                                     NoRcp,
