...
namespace trade
{
    ...
    // 프로젝트  명 : P_TR_EXTO
    // **************************************
    public partial class P_TR_EXTO : Duzon.Common.Forms.PageBase
    {
        #region ★ 멤버필드
            ...
            try
            {
                switch (((Control)sender).Name)
                {
                    case "txt신고번호":
                        ...
                        break;
                    case "cur기표환율":
                        cur원화금액.DecimalValue = cur기표환율.DecimalValue * cur금액.DecimalValue;
                    ...
                    case "cur면장환율":
                        //curFOB원화금액.DecimalValue = cur면장환율.DecimalValue * cur금액.DecimalValue;
                        //_header.CurrentRow["AM_FOB"] = curFOB원화금액.DecimalValue;
                        curFOB원화금액.DecimalValue = cur면장환율.DecimalValue * curFOB금액.DecimalValue;
                        _header.CurrentRow["AM_FOB"] = curFOB원화금액.DecimalValue;
                        break;
