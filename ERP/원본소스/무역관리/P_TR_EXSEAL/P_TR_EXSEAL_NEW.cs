...
// 서브시스템명 : 수출
// 페 이 지  명 : 인수증등록
// 프로젝트  명 : P_TR_EXSEAL_NEW
// 수 정 내 역  : 2013.07.25 - 윤성우 - ONE GRID 수정(입력 전용)
// **************************************

namespace trade
{
    public partial class P_TR_EXSEAL_NEW : PageBase
    {
        #region ♣변수선언
        ...
        protected override void InitPaint()
        {
            ...
            m_pnlMain.UseCustomLayout = true;

            bpPanelControl1.IsNecessaryCondition = bpPanelControl2.IsNecessaryCondition =
            bpPanelControl4.IsNecessaryCondition = bpPanelControl5.IsNecessaryCondition = bpPanelControl6.IsNecessaryCondition =
            bpPanelControl9.IsNecessaryCondition = bpPanelControl12.IsNecessaryCondition = true;
            m_pnlMain.IsSearchControl = false; //2013.07.25 - 윤성우 - ONE GRID 수정(입력 전용)

            m_pnlMain.InitCustomLayout();
