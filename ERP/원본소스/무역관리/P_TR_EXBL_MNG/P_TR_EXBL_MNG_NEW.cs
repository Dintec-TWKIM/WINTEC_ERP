...
namespace trade
{
    public partial class P_TR_EXBL_MNG_NEW : PageBase
    {
        #region ♣ 초기화 이벤트 / 메소드
        ...
        protected override void InitPaint()
        {
            ...
            bpPanelControl1.IsNecessaryCondition = bpPanelControl2.IsNecessaryCondition = true;
            ...
            pp기표기간.StartDateToString = Global.MainFrame.GetStringFirstDayInMonth;
        ...
        {
            if (!BeforeSearch() || !Chk기표기간) return false;
            ...
            str기표기간시작 = pp기표기간.StartDateToString;
            str기표기간끝 = pp기표기간.EndDateToString;
        ...
        private void btn전표발행취소_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string strSearchQuery = "SELECT DISTINCT NO_DOCU FROM FI_DOCU WHERE CD_COMPANY = '" + LoginInfo.CompanyCode + "' AND NO_MDOCU IN (" + 선적번호들 + ") ";
        ...
        bool Chk기표기간 { get { return Checker.IsValid(pp기표기간, true, label5.Text); } }
